...
.fc-rtl .fc-time-grid .fc-now-indicator-arrow {
  ...
  border-top-color: transparent;
  border-bottom-color: transparent;
}`;class Ts{static FromEventData(e){var t=new Ts;return t.title=e.summary?e.summary:e.title,t.start=e.start.date?e.start.date:e.start.dateTime?e.start.dateTime:e.start,t.end=e.end.date?e.end.date:e.end.dateTime?e.end.dateTime:e.end,t.allDay=!!e.start.date,t}static FromEntity(e,t){var n=new Ts,r=e.states[t.entity];if(n.title=t.name?entiyConf.name:r.attributes.friendly_name,"timestamp"===r.attributes.device_class)n.start=r.state;else{r.entity_id.split(".")[0];n.start=r.attributes.last_changed?r.attributes.last_changed:r.last_changed}return n.allDay=!0,n}}class Cs{constructor(){this.eventData={}}async getEvents(e,t,n,r){if(!e)return[];var i=t.entity;return"calendar"==i.split(".")[0]?this.getCalendarEvents(e,i,n,r):[Ts.FromEntity(e,t)]}async getCalendarEvents(e,t,n,r){let i=`calendars/${t}?start=${n.toISOString()}&end=${r.toISOString()}`;var o=(await e.callApi("get",i)).map(e=>Ts.FromEventData(e));let s=this.eventData[t]||[];return s.push(...o),this.eventData[t]=s.filter((e,t)=>{const n=JSON.stringify(e);return t===s.findIndex(e=>JSON.stringify(e)===n)}),this.eventData[t]}}customElements.define("fullcalendar-card",class extends ee{setConfig(e){if(!e||!e.entities)throw new Error("Invalid configuration");this._config=e,this.entities=this.processConfigEntities(this._config.entities),this.calendarService=new Cs}createRenderRoot(){return this}get hostcss(){return this.isPanel?O`<style type="text/css">
			:host #calendar {
        		width: 100%;
        		height: 100%;
